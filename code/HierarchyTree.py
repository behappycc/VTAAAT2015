...
class Tree:
    ...
    def remove_node(self, identifier, parent=None):
        self[parent].remove_child(identifier)
    ...
    def clickAndMerge(self, identifier):
        yield identifier
        queue = self[identifier].children
        while queue:
            yield queue[0]
...
def main():
    ...
    tree.add_node("Hubert", "Harry")
    tree.remove_node("Hubert", "Harry")
